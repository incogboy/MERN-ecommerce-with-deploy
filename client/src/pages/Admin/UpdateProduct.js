...
const UpdateProduct = () => {
    ...
    const handleUpdateProduct = async (e) => {
        ...
        try {
            ...
            toast.error('Something wrong went Updated product')
            console.log(error)
        }
    }
    ...
    const handleDeleteProduct = async () => {
        try {
            ...
            toast.error('something wrong went Deleted Product')
            console.log(error)
        }
    }
                        ...
                        <div className='m-1 w-75'>
                            ...
                            <div className='mb-3'>
                                {photo ? (
                                    ...
                                    <div className='text-center'>
                                        <img src={`${process.env.REACT_APP_API}/api/v1/products/product-photo/${id}`} alt='product_photo' height='200px' className='img img-responsive' />
                                    </div>
                                )}
                            </div>
                            <div className='mb-3'>
                            ...
                            <div className='mb-3'>
                                <textarea type='text-area' value={description} placeholder='write a description' className='form-control' onChange={(e) => setDescription(e.target.value)} />
                            </div>
                            <div className='mb-3'>
