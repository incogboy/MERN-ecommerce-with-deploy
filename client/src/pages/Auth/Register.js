...
const Register = () => {
    ...
    return (
        <Layout title={'Register - Simple Commerce'}>
            <div className='form-container' style={{ minHeight: '90vh' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputEmail1" placeholder='What is your mother name ?' required />
                    </div>
