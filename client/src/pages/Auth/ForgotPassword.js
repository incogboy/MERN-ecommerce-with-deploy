...
const ForgotPassword = () => {
    ...
    return (
        <Layout title={'Forgot Password - Simple Commerce'}>
            <div className='form-container' style={{ minHeight: '90vh' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputEmail1" placeholder='Enter your mother name' required />
                    </div>
