...
export const registerController = async (req, res) => {
    try {
        ...
        console.log(`registerController problem: ${error}`.bgRed.white)
        res.status(500).send({
            success: false,
...
export const loginController = async (req, res) => {
    try {
        ...
        console.log(`loginController error: ${error}`.bgRed.white)
        res.status(500).send({
            success: false,
...
export const UpdateProfileController = async (req, res) => {
    try {
        ...
        if (password && password.length < 6) {
            return res.json({
                error: 'Password is require and must 6 character long'
            })
        }
